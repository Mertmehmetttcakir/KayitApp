-- Mevcut RLS politikalarını silme
...
DROP POLICY IF EXISTS "Müşteriler kendi araçlarını görebilir" ON vehicles;
DROP POLICY IF EXISTS "Yöneticiler tüm araçları görebilir" ON vehicles;
DROP POLICY IF EXISTS "Yöneticiler ve teknisyenler tüm araçları görebilir" ON vehicles;
DROP POLICY IF EXISTS "Müşteriler kendi araçlarını oluşturabilir" ON vehicles;
DROP POLICY IF EXISTS "Yöneticiler araç oluşturabilir" ON vehicles;

DROP POLICY IF EXISTS "Müşteriler kendi randevularını görebilir" ON appointments;
DROP POLICY IF EXISTS "Teknisyenler kendilerine atanan randevuları görebilir" ON appointments;
DROP POLICY IF EXISTS "Yöneticiler tüm randevuları görebilir" ON appointments;
DROP POLICY IF EXISTS "Yöneticiler ve teknisyenler tüm randevuları görebilir" ON appointments;

DROP POLICY IF EXISTS "Müşteriler kendi servis geçmişini görebilir" ON service_history;
DROP POLICY IF EXISTS "Yöneticiler tüm servis geçmişini görebilir" ON service_history;
DROP POLICY IF EXISTS "Yöneticiler ve teknisyenler tüm servis geçmişini görebilir" ON service_history;

DROP POLICY IF EXISTS "Herkes teknisyenleri görebilir" ON technicians;
...
DROP POLICY IF EXISTS "Kullanıcılar kendi profillerini güncelleyebilir" ON user_profiles;
